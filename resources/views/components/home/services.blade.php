<div x-data="{ currentTab: 'tab1' }" class="w-full max-w-md mx-auto">
    ...
    <!-- Tab Content -->
    <div class="mt-6">
      <div x-show="currentTab === 'tab1'" x-cloak class="">
        <div class="bg-white/10 p-8 rounded-lg shadow-lg">
            <div class="bg-green-500 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
